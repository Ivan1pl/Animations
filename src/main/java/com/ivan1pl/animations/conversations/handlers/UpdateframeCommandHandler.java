 ...
 * @author Ivan1pl
 */
public class UpdateframeCommandHandler extends ConversationCommandHandler {

    private final Prompt successPrompt;

    private final Prompt failPrompt;

    public UpdateframeCommandHandler(Prompt successPrompt, Prompt failPrompt) {
        super("updateframe", 1, "frame_index");
